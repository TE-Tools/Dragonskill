-- Dragon Skill - Complete Gear & Loot Database (v2.0.0)
...
AddDungeon("King's Rest", {
    { name = "The Golden Serpent", loot = { 159458, 159459 } },
    { name = "Mchimba the Embalmer", loot = { 159460, 159461 } },
    { name = "Council of Tribes", loot = { 159462, 159463 } },
    { name = "Dazar, the First King", loot = { 159464, 159465 } }
})

AddDungeon("Temple of Sethraliss", {
    { name = "Adderis and Aspix", loot = { 158300, 158301 } },
    { name = "Merektha", loot = { 158302, 158303 } },
    { name = "Galvazzt", loot = { 158304, 158305 } },
    { name = "Avatar of Sethraliss", loot = { 158306, 158307 } }
})

AddDungeon("Ruby Life Pools", {
    { name = "Melidrussa Chillworn", loot = { 193760, 193761 } },
    { name = "Kokia Blazehoof", loot = { 193762, 193763 } },
