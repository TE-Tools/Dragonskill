...
AddItem(270173, { name = "Voracious Heart of Ula'tek", slot = "Trinket" })
AddItem(270175, { name = "Living Spore Pod", slot = "Trinket" })
AddItem(268213, { name = "Maze-roa, Warlord's Fury", slot = "Two-Hand" })
AddItem(271528, { name = "Gaze of the Coiled Watcher", slot = "Head", tierItem = true })
AddItem(268266, { name = "Ring of Wavecalling", slot = "Ring" })
AddItem(268265, { name = "Amani Pendant", slot = "Neck" })
AddItem(268253, { name = "Cloak of Coiling Souls", slot = "Cloak" })
AddItem(268259, { name = "Belt of the Annihilator", slot = "Belt" })
AddItem(268249, { name = "Signet of the Malignant", slot = "Ring" })
AddItem(271600, { name = "Boots of the Sentinel", slot = "Boots" })
AddItem(270165, { name = "Eye of the Watcher", slot = "Trinket" })
AddItem(270162, { name = "Soulcoil Shard", slot = "Trinket" })
