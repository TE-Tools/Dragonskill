-- Dragon Skill - Module: AI Coach Chat UI (v2.0.5)
-- Optimized Chat View with Branding and Sync Button.
...
function AICoachUI:Draw(content, width)
    ...
    if not self.historyFrame then
        ...
        self.historyText:SetText("|cffaaaaaaSchreib eine Frage! Der Coach antwortet sofort lokal, waehrend die KI im Hintergrund laeuft.|r")
        self.historyFrame = h
    end
    ...
    if not self.syncBtn then
        ...
        btn:SetScript("OnEnter", function(s)
            ...
            GameTooltip:SetText("Sobald das Bridge-Programm auf deinem PC 'Fertig' anzeigt, klicke hier.")
            GameTooltip:Show()
        end)
